...
export default function alovetPage() {
    ...
    const [races, setRaces] = useState([860, 879])
    const [round, setRound] = useState(860)
    ...
    const driverToTeam = { 'Hamilton': 'Mclaren', 'Button': 'Mclaren', 'Webber': 'Redbull', 'Vettel': 'Redbull', 'Alonso': 'Ferrari', 'Räikkönen' : 'Lotus', 'Rosberg' : 'Mercedes', 'Maldonado' : 'Williams' }
    ...
    <div id="background" style={{backgroundImage: `url(/bgf3.jpg)`}}></div>
            <article style={{ textAlign: 'center', marginLeft: '2rem', marginRight: '2rem' }}>
                ...
                <h1 style={{ textAlign: 'center', fontSize: '40px' }}>Mundial de 2012 : Tercer enfrontament</h1>
                <h2 style={{ fontSize: '30px' }}> Una altre oportunitat per a Alonso </h2>

                <p style={{ color: "#121f45", fontSize: '25px', fontWeight: 'bold' }}> Una temporada molt més igualada, que va tornar a decidir-se a la última cursa</p>
